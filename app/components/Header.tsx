      ...
      <>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '10px', width: '100%', height: '100%', minWidth: 0 }}>
            ...
            >
              <span style={{ fontSize: '20px', lineHeight: 1.05, fontWeight: 'bold', whiteSpace: 'nowrap' }}>TemAuto</span>
              <span
                aria-hidden="true"
                style={{
                  display: 'flex',
              ...
              >
                <svg viewBox="0 0 64 32" width="44" height="24" role="img" aria-hidden="true">
        ...
        <div aria-hidden="true" style={{ height: '72px', flex: '0 0 72px' }} />
      </>
    )
  }
