...
function getCarImage(car: any): string {
  ...
  if (!rawImg) return 'https://via.placeholder.com/100x65?text=Nav+bildes'
  ...
  return 'https://via.placeholder.com/100x65?text=Nav+bildes'
}
          ...
          <div>
            {loading ? (
              ...
              <div style={{ textAlign: 'center', padding: '40px', backgroundColor: '#fff', borderRadius: '8px', border: '1px solid #e5e7eb', color: '#6b7280' }}>
                Nav atrasts neviens sludinājums, kas atbilst izvēlētajiem kritērijiem.
              </div>
            ) : (
