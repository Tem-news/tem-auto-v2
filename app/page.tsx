  ...
  return (
    <div ref={dropdownRef} style={{ width: '100%', maxWidth: '1600px', margin: '0 auto', padding: '16px 12px', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '270px 1fr 240px', gap: '16px', alignItems: 'start', width: '100%' }}>
        ...
        {/* KREISĀ PUSE */}
        <div style={{ position: 'sticky', top: '64px', alignSelf: 'start', minHeight: '500px', backgroundColor: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '6px', boxSizing: 'border-box' }}>
          {loading ? (
        ...
        <div style={{ minWidth: 0, width: '100%', alignSelf: 'start' }}>
          ...
          {/* FILTRI - Pievienots solīds background un top: 64px, lai nav šķirbas un nespīd cauri */}
          <div style={{ 
            position: 'sticky', 
            top: '64px', 
            zIndex: 30, 
        ...
        <div style={{ position: 'sticky', top: '64px', alignSelf: 'start', display: 'flex', flexDirection: 'column', gap: '16px' }}>
